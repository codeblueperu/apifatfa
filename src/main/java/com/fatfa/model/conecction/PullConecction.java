package com.fatfa.model.conecction;
...
@EnableJpaRepositories("com.fatfa.model.repository")
@ComponentScan("com.fatfa*")
public class PullConecction {
	...
	public EntityManagerFactory entityManagerFactory() {
		...
		factory.setPackagesToScan(new String[] { "com.fatfa.model.entity" });
